...
export declare abstract class EntityItem<T> {
    abstract GetQueryString(): string;
}
export declare abstract class EntitySet<TEntity extends EntityBase<TEntity>> extends EntityItem<TEntity> {
    EntityType: {
        new (): TEntity;
    };
...
export declare abstract class Column<TColumn extends boolean | number | string | null> extends EntityItem<TColumn> {
    GetColumn: {
        (): string;
    };
